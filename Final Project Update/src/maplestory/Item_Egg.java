...
public class Item_Egg extends Item{
	protected static int item_code = 7;
	protected static String type = "Consume";
	protected static String name = "달걀";
	protected static String tooltip = "영양 만점의 계란이다.\nHP를 약 50 회복시킨다.";
	protected static ImageIcon Dropped_Icon = Maplestory.images.Egg_Raw_Icon;
	protected static ImageIcon Icon = Maplestory.images.Egg_Icon;
	protected static ImageIcon Info = Maplestory.images.Egg_Info;
	...
	public Item getNew(int Quantity) {
		Item result = new Item_Egg(Quantity);
		return result;
	}
}
