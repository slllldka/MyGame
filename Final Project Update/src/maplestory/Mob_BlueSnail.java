...
public class Mob_BlueSnail extends Mob {
	protected static final String name = "파란 달팽이";
	protected static final int width = 35, height = 35;
	protected static final int level = 2;
	protected static final int MaxHP = 15, MaxMP = 0;
	protected static final int Min_ATK = 3, Max_ATK = 3;
	protected static final int DEF = 10;
	protected static final long Exp = 4;
	...
	public Mob_BlueSnail(int Location_Percent, Foothold _foothold, boolean _respawn) {
		...
		StandImg = Maplestory.images.BlueSnailStand;

		MoveImg[0] = Maplestory.images.BlueSnailMove0;
		MoveImg[1] = Maplestory.images.BlueSnailMove1;
		MoveImg[2] = Maplestory.images.BlueSnailMove2;
		MoveImg[3] = Maplestory.images.BlueSnailMove3;

		DieImg[0] = Maplestory.images.BlueSnailDie0;
		DieImg[1] = Maplestory.images.BlueSnailDie1;
		DieImg[2] = Maplestory.images.BlueSnailDie2;

		HitImg = Maplestory.images.BlueSnailHit;
	...
	public void dropItem() {
		synchronized(Maplestory.current_stage.Item_List) {
			...
			if(random2 >= 1 && random2 <= 8000 ) {
				Item item = new Item_Blue_Shell(1);
